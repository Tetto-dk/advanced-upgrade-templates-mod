...
public class ModItems {
    ...
    public static final Item NETHERRACK_ROCK = registerItem("netherrack_rock", new Item(new Item.Settings()));
    public static final Item GILDED_BLACKSTONE_ROCK = registerItem("gilded_blackstone_rock", new Item(new Item.Settings()));
    public static final Item TEMPLATE_BASE = registerItem("template_base", new Item(new Item.Settings()));
    public static final Item SMELTED_TEMPLATE_BASE = registerItem("smelted_template_base", new Item(new Item.Settings()));
    public static final Item CLUMP_GILDED_BLACKSTONE_ROCKS = registerItem("clump_of_gilded_blackstone_rocks", new Item(new Item.Settings()));
    public static final Item NETHERITE_DIAMOND_UPGRADE_SMITHING_TEMPLATE = registerItem("netherite_diamond_upgrade_smithing_template", new Item(new Item.Settings()){
        @Override
    ...
    public static final Item NETHERITE_EMERALD_UPGRADE_SMITHING_TEMPLATE = registerItem("netherite_emerald_upgrade_smithing_template", new Item(new Item.Settings()){
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
    ...
    public static final Item NETHERITE_GOLD_UPGRADE_SMITHING_TEMPLATE = registerItem("netherite_gold_upgrade_smithing_template", new Item(new Item.Settings()){
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
    ...
    public static final Item NETHERITE_IRON_UPGRADE_SMITHING_TEMPLATE = registerItem("netherite_iron_upgrade_smithing_template", new Item(new Item.Settings()){
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
    ...
    public static Item registerItem(String name, Item item) {
        ...
        return Registry.register(Registries.ITEM, Identifier.of(AdvancedUpgradeTemplatesMod.MOD_ID, name), item);
    }
